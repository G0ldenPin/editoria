...
<head>
    ...
    <!-- Google Fonts: Outfit con pesi multipli (300, 400, 500, 600, 700, 800) -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        :root {{
            /* Palette Richiesta (Flat UI creativa):
               - Protagonisti Turchesi: #16A085 (Teal profondo) & #1ABC9C (Turchese brillante)
               - Accenti caldi: #F1C40F (Giallo solare), #E67E22 (Arancione caldo), #E74C3C (Rosso corallo)
               - Bianco e nero non puri per il massimo comfort visivo */
            --c-primary: #16A085;        /* Protagonista 1: Teal scuro / Green Sea */
            --c-primary-dark: #0f6c59;   /* Teal notte per sfumature e contrasti */
            --c-footer-bg: #0d2320;      /* Sfondo scuro per il footer */
            --c-secondary: #1ABC9C;      /* Protagonista 2: Turchese brillante e luce */
            --c-secondary-light: #e8f8f5;/* Tinta chiarissima di turchese per sfondi/evidenziazioni */
            --c-secondary-glow: rgba(26, 188, 156, 0.35);
            
            /* Accenti caldi */
            --c-yellow: #F1C40F;         /* Giallo solare / oro (dettagli, bordi badge header, top footer) */
            --c-orange: #E67E22;         /* Arancio caldo (prospettiva concettuale-filosofica) */
            --c-red: #E74C3C;            /* Rosso corallo vivo (pulsanti azione "Proponi modifica", link hover) */
            
            /* Bianco e Nero non puri */
            --c-bg: #f4f8f7;             /* Sfondo pagina: bianco fresco e pulito */
            --c-card-bg: #ffffff;        /* Sfondo tessere: bianco ottico */
            --c-text: #152220;           /* Testo principale: nero carbone con riflesso teal */
            --c-text-muted: #556c67;     /* Testo secondario: ardesia-teal medio */
            --c-border: #cfe0dc;         /* Bordo tenue */
            --c-border-light: #e6f2ef;
        }}
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        header {{
            ...
            padding: 3rem 1.5rem;
            text-align: center;
            box-shadow: 0 4px 14px rgba(15, 108, 89, 0.2);
        }}
        header h1 {{
            font-size: 2.35rem;
        ...
        .controls-card {{
            ...
            border-radius: 14px;
            padding: 1.6rem;
            box-shadow: 0 10px 25px -5px rgba(22, 160, 133, 0.08), 0 4px 6px -2px rgba(22, 160, 133, 0.03);
        ...
        .btn-toggle.active {{
            ...
            font-weight: 600;
            box-shadow: 0 2px 5px rgba(22, 160, 133, 0.25);
        }}
        .btn-download {{
        ...
        .concept-card {{
            ...
            padding: 1.6rem;
            box-shadow: 0 4px 6px -1px rgba(22, 160, 133, 0.05);
            display: flex;
            flex-direction: column;
            justify-content: space-between;
        ...
        .concept-card:hover {{
            ...
            box-shadow: 0 12px 24px -4px rgba(22, 160, 133, 0.16);
